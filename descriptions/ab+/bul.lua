...
EID.descriptions[languageCode].collectibles={
	...
	{"133", "Лапата на Гъпи", "Превръща 1 контейнер за червено сърце в 3 духовни сърца"},   -- explicit mention of "on use"?
	{"134", "Опашката на Гъпи", "{{Chest}} 33% шанс да замени наградата за минаване на стая със сандък#33% шанс да не се създаде награда след премината стая"},
	{"135", "Кръвна банка", "{{HalfHeart}} Отнема половин червено сърце и създава 1-3 монети#{{Player14}} Създава 0-1 монети за Търговеца"},   -- extra "{{HalfHeart}}" tag against en_us.lua
	{"136", "Най-добър приятел", "Създава примамка, която привлича чудовищата и след 5 секунди избухва"},
	{"137", "Детонатор", "{{Bomb}} +5 бомби#Бомбите експлодират само при използване на детонатора"},
	{"138", "Стигмата", "↑ {{Heart}} +1 здраве#↑ {{Damage}} +0.3 щети"},
	{"139", "Чантата на мама", "{{Trinket}} Позволява ти да носиш 2 дрънкулки"},
	{"140", "Проклятието на Боб", "{{Bomb}} +5 бомби#{{Poison}} Бомбите отравят чудовищата, попаднали във взрива"},
	{"141", "Артистично момче", "{{Coin}} Създава 7 произволни монети"},    -- translation check: "pageant" could loosely be described in 2 words as (US)"beauty show"/(UK)"historical reenactment", nothing more accurate possible for the translation
	{"142", "Скапуляр", "{{SoulHeart}} Ако сте поели щети и сте останали на половин сърце, дава 1 духовно сърце#Случва се само веднъж на стая"},   -- translation check: transliteration/borrow from Russian word, again with the note of this religious term possibly not existing
	...
	{"144", "Просяк-приятел", "{{Coin}} Събира монети и създава предмети по пода в замяна"},
	{"145", "Главата на Гъпи", "Създава 2-4 съюзнически мухи"},
	{"146", "Молитвена карта", "{{EternalHeart}} +1 вечно сърце#Добавя се направо към твоето здраве"},
	{"147", "Кирка", "Позволява чупене на скали и отваряне на стени към {{SecretRoom}}тайни стаи в сегашната стая"},
	{"148", "Нашествие", "При поемане на щети се създават 1-3 съюзнически мухи"},  -- translation check: word used here may mean "animal/insect infestation", but also "invasion" (corrected from "infection")
	{"149", "Буркан с отрова", "Сълзите летят в дъга#{{Poison}} При контакт или падане избухват и отравят близки чудовища#↑ {{Damage}} +40 щети#↓ {{Tears}} По-малко сълзи"},
	{"150", "Трудна любов", "10% шанс за изстрел на зъб с {{Damage}} 3.2x щети#{{Luck}} 100% шанс при 9 късмет"},
	{"151", "Мълиганът", "1/6 шанс да създаде муха при всеки удар по чудовище"}, -- most relevant non-tear attacks may also spawn flies, therefore the translation generalizes without the "tears" word
	{"152", "Технология 2", "На дясното око сълзите се заместват с лазер с висока честота#Лазерът нанася 20% от щетите на играча#↓ {{Damage}} -35% щети"}, -- retracted: #↓ {{Tears}} Период между сълзите x 2 // -- AB+ en_us.lua claims Tear Delay x 2. Was there a tears down to Tech 2 before Repentance?? ~~Wiki also claims: "Tear delay is effectively doubled, as Isaac will do a bit of the animation to fire a right eye tear, but no tear will come out."
	{"153", "Паяк мутант", "Стреляш по 4 сълзи наведнъж#↓ {{Tears}} По-малко сълзи"},
	{"154", "Химическо изгаряне", "↑ {{Damage}} +2 щети за сълзи от лявото око"},
	{"155", "Зъркелът", "Лети из стаята#Нанася 17.1 щети в секунда при докосване"},
	{"156", "Калугерска одежда", "{{Battery}} Добавя 1 заряд на активният предмет, когато те ударят"},    -- translation check: roughly "Nun's habit", though in this form the first word used is not gendered like "Nun" is
	{"157", "Жажда за кръв", "↑ {{Damage}} Повече щети, когато те ударят#Ефектът се наслагва до 6 пъти на етаж#Продължава до края на етажа"},   -- когато <?-?> щом
	{"158", "Кристална топка", "Показва цялата карта на етажа (с изключение на супер тайната стая)#Дава духовно сърце или произволна карта"},
	{"159", "Дух на нощта", "Летене#Спектрални сълзи"},
	{"160", "Удар от небето", "При използване, пуска 5 лъчи светлина върху чудовищата#Нанася щетите на играча + 20"},  -- translation check: literally "Hit from the sky"
	{"161", "Анкх", "{{Player4}} След като умреш, се прераждаш като ??? (Синьото бебе)"},
	{"162", "Келтски кръст", "Шанс за временна неуязвимост при поемане на щети#{{Luck}} 100% шанс при 27 късмет"},
	{"163", "Бебе дух", "Спътник със спектрални сълзи#Прави 3.5 щети на сълза"},
	{"164", "Свещта", "Изстрелва син пламък#Пламъкът нанася щети при контакт и блокира сълзи от чудовища#Изчезва след 2 секунди"},
	{"165", "Котка с девет опашки", "↑ {{Damage}} +1 Щети#↑ {{Shotspeed}} +0.23 скорост на сълзите"},
	{"166", "D20", "Променя предметите по пода в стаята"}, -- prime example of "pickups"!
	{"167", "Бебе Арлекин", "Спътник с V-образни сълзи#Прави 4 щети на сълза"},
	{"168", "Епичен ембрион", "Сълзите се заменят с мерник по пода#След 1.5 секунди на мерника пада ракета#Ракетите нанасят 20х щетите на играча"},
	{"169", "Полифем", "Мега сълзи!#↑ {{Damage}} Увеличени щети: (Щети + 4) x 2#↓ {{Tears}} По-малко сълзи#След като убият чудовище, сълзите отиват напред с останалата щета"},    -- The en_us desc of the Damage formula is erroneously simplified (at least, 4 additional damage should be 8 if we are describing it that way).
	{"170", "Татко Дълги Крака", "Спътник, който настъпва чудовищата в стаята#Прави 40 щети в секунда"},   -- translation check: literal translation, leaves ambiguous what kind of spider the familiar is
	{"171", "Паяшки задник", "забавя чудовищата за 4 секунди#Прави по 10 щети на всяко чудовище"}, -- TODO: Item171 continue from here
